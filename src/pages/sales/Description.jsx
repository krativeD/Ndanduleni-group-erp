...
const Description = () => {
  // Initialize from localStorage or default services
  const getInitialServices = () => {
    const stored = localStorage.getItem('ndanduleni_services');
    if (stored) {
  ...
  useEffect(() => {
    localStorage.setItem('ndanduleni_services', JSON.stringify(services));
  }, [services]);
