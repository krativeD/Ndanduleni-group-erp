  ...
  return (
    <div className={styles.dashboard}>
      ...
      <div className={styles.statsGrid}>
        <StatCard title="Department Staff" value={stats.totalEmployees} icon="👥" trend="up" trendValue={1.8} color="primary" />
        <StatCard title="Department Revenue" value={`R ${(stats.totalRevenue / 1000).toFixed(0)}k`} icon="💰" trend="up" trendValue={8.3} color="success" />
        <StatCard title="Active Projects" value={stats.activeProjects} icon="📊" trend="up" trendValue={4.1} color="info" />
        <StatCard title="Attendance Rate" value={`${stats.attendanceRate}%`} icon="📅" trend="up" trendValue={1.5} color="success" />
      </div>
